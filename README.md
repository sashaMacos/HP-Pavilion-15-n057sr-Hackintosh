...
Так же тут используются более правильные ACPI. Более правильный завод USB портов. Плюс более правильный завод трекпада, теперь он работает лучше. На этои конфиге был протестирован установщик macOS 15 Sequoia, а это значит, что все новые macOS которые адоптированы под intel и есть на момент 27 декабря 2024 года будут работать на этом конфиге, с OCLP.
**ВАЖНО** Я добавил Kext RestrictEvents(+ ключь в NVRAM) благодаря которому можно поставить macOS не совместимою с вашем SMBIOS, это значит что для установки более не надо использовать EFI_INSTALL, но я его оставил для Вас, на случай проблем с kext.
